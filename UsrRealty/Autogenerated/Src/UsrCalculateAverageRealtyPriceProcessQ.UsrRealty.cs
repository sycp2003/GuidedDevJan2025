namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAverageRealtyPriceProcessQMethodsWrapper

	/// <exclude/>
	public class UsrCalculateAverageRealtyPriceProcessQMethodsWrapper : ProcessModel
	{

		public UsrCalculateAverageRealtyPriceProcessQMethodsWrapper(Process process)
			: base(process) {
